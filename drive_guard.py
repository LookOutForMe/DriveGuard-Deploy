...
# Path to CSV file
csv_file_path = 'drowsiness_status.csv'
...
pygame.mixer.init()
alarm_sound = pygame.mixer.Sound("alert.wav")  # Replace "alert.wav" with your sound file
...
def generate_frames(username):
    ...
    while True:
        ...
        faces = detector(gray)
        face_frame = frame.copy()  # Initialize face_frame outside of the loop
